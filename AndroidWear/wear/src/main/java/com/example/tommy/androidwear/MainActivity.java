...
public class MainActivity extends Activity{
    ...
    void onGenerate(){
        ...
        //保存文件到手表中
        File xAcceDataFile = writeArrayFile(SensorService.xAcceArray,"xAcceData.txt");
        File yAcceDataFile = writeArrayFile(SensorService.yAcceArray,"yAcceData.txt");
        File zAcceDataFile = writeArrayFile(SensorService.zAcceArray,"zAcceData.txt");

        File xGyroDataFile = writeArrayFile(SensorService.xGyroArray,"xGyroData.txt");
        File yGyroDataFile = writeArrayFile(SensorService.yGyroArray,"yGyroData.txt");
        File zGyroDataFile = writeArrayFile(SensorService.zGyroArray,"zGyroData.txt");
